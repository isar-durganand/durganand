...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[100svh] flex items-center pt-24 sm:pt-32 pb-16 sm:pb-32 px-4 sm:px-6 overflow-hidden">
      <div className="max-w-5xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
        {/* Left: Copy (7 cols) */}
        <div className="lg:col-span-7 space-y-6 sm:space-y-8">
          ...
          >
            ...
            <p className="text-xs sm:text-sm font-mono text-carbon-500 dark:text-carbon-400">
          ...
          <h1
            ...
            className="font-display font-bold text-3xl sm:text-5xl lg:text-6xl xl:text-7xl tracking-display leading-[1.12] sm:leading-[1.1]"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base lg:text-lg text-carbon-600 dark:text-carbon-300 max-w-lg leading-relaxed font-body"
          >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.96 }}
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-accent text-white font-medium font-body text-sm rounded-xl hover:bg-accent-hover transition-colors cursor-pointer w-full sm:w-auto text-center"
            >
              View Work
              <ArrowDown size={16} />
            </motion.a>
            <motion.a
              ...
              whileTap={{ scale: 0.96 }}
              className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-carbon-200 dark:border-carbon-700 text-carbon-600 dark:text-carbon-300 font-medium font-body text-sm rounded-xl hover:border-carbon-400 dark:hover:border-carbon-500 hover:text-carbon-950 dark:hover:text-carbon-50 transition-colors cursor-pointer w-full sm:w-auto text-center"
            >
              <Mail size={16} />
              Get in Touch
            </motion.a>
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-end mt-2 lg:mt-0">
          ...
          >
            ...
            <div className="relative w-60 h-72 sm:w-72 sm:h-[22rem] lg:w-80 lg:h-[26rem] rounded-2xl border border-carbon-200 dark:border-carbon-700 overflow-hidden shadow-xl">
              <img
                src="/profile.webp"
                ...
                loading="eager"
              />
              <div className="absolute inset-0 bg-accent/[0.06] mix-blend-multiply pointer-events-none" />

              {/* Floating status chip inside portrait */}
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1.2, type: 'spring', stiffness: 300, damping: 30 }}
                className="absolute bottom-3 left-3 right-3 bg-carbon-950/75 dark:bg-carbon-950/85 frosted-surface border border-carbon-700/50 rounded-xl px-3 py-2 flex items-center gap-2"
              >
                <motion.span
                ...
                />
                <span className="text-xs font-mono text-carbon-200 truncate">
                  Available for opportunities
                </span>
              </motion.div>
            </div>

            {/* Accent side bar (hidden on small screens to prevent overflow) */}
            <div className="hidden sm:block absolute top-6 -right-3 w-1 h-16 bg-accent rounded-full" />
          </motion.div>
        </div>
      </div>
      ...
      >
        <motion.div
          ...
          className="w-5 h-8 border border-carbon-400/40 rounded-full flex justify-center pt-1.5"
        >
